...
<section class="">
  ...
  <div class="rightPanel">
    <form class="loginForm" action="" method="post" autocomplete="off" on:submit|preventDefault={HandleRegister}>
      <h2 class="loginFormH2">Register</h2>
      <input
      bind:value={username}
        class="txtInput"
        type="text"
    ...
    <p class="haveacclbl text-gray-400">
      Already have an account? <a href="#google" class="reglink">Log in</a>
    </p>
  </div>
</section>
